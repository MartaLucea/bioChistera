    ...
    <div id="faq-contenidor" aria-live="polite">
        ...
        <div class="faq-grup" data-cat="mercat">
            ...
            <div class="faq-resposta" role="region">
                <p>Ve a la pàgina <a href="pujar-material.php">Pujar material</a>, omple el formulari amb el títol, categoria, descripció, preu (o marca-ho com a donació / intercanvi) i afegeix fotos. Un cop enviat, l'article apareixerà al mercat en pocs minuts.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="mercat">
            ...
            <div class="faq-resposta" role="region">
                <p>Sí! BioChistera promou la donació i l'intercanvi. En crear l'article pots escollir entre «Venda», «Intercanvi» o «Donació». Les donacions i intercanvis estan especialment valorats per la comunitat perquè contribueixen directament als nostres ODS.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="compte">
            ...
            <div class="faq-resposta" role="region">
                <p>A cada article hi trobaràs un botó «Contactar». En fer-hi clic s'obrirà un formulari de missatge intern. L'usuari rebr un avís i podrà respondre't des del seu perfil. Mai compartim el correu electrònic públicament.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="tutorials">
            ...
            <div class="faq-resposta" role="region">
                <p>Ve a la pàgina <a href="tutorials.php">Tutorials</a> i fes clic a «Pujar tutorial». Necessites un compte actiu. Pots enganxar l'URL d'un vídeo de YouTube o Vimeo i afegir un títol i descripció. La comunitat podrà veure'l immediatament.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="tutorials">
            ...
            <div class="faq-resposta" role="region">
                <p>Sí! Amb un compte registrat pots deixar un «m'agrada» i un comentari a qualsevol tutorial. Les valoracions ajuden la comunitat a trobar el contingut de més qualitat.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="ods">
            ...
            <div class="faq-resposta" role="region">
                <p>La plataforma s'alinea principalment amb tres Objectius de Desenvolupament Sostenible de l'ONU: <strong>ODS 3</strong> (Salut i benestar), <strong>ODS 10</strong> (Reducció de desigualtats) i <strong>ODS 17</strong> (Aliances per als objectius). A més, la reutilització de material connecta amb l'<strong>ODS 12</strong> (Producció i consum responsables). <a href="ods.php">Llegeix-ne més aquí.</a></p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="ods">
            ...
            <div class="faq-resposta" role="region">
                <p>Fem servir imatges optimitzades per reduir el pes de la web, el codi minimitza les peticions innecessàries a l'API i disposem de <strong>Mode Fosc</strong> per estalviar energia en pantalles OLED. <a href="practiques-sostenibles.php">Vés a la pàgina de pràctiques sostenibles</a> per saber-ne tots els detalls.</p>
            </div>
        </div>
        ...
        <div class="faq-grup" data-cat="tecnics">
            <button class="faq-pregunta" aria-expanded="false">
                <span><span class="badge-cat tecnics">Tècnic</span>Com reporto un error o un article inadequat?</span>
                <span class="icona">+</span>
            </button>
            <div class="faq-resposta" role="region">
                <p>A cada article hi ha un botó «Reportar». Per errors tècnics pots obrir una issue al nostre repositori o escriure'ns directament a través del formulari de contacte. Intentem respondre en menys de 48 hores.</p>
            </div>
        </div>
