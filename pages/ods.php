                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back flip-card-back--3">
                                ...
                                <a href="../pages/odss.php?ods=3" class="flip-card__btn">Saber-ne més →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back flip-card-back--10">
                                ...
                                <a href="../pages/odss.php?ods=10" class="flip-card__btn">Saber-ne més →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back flip-card-back--12">
                                ...
                                <a href="../pages/odss.php?ods=12" class="flip-card__btn">Saber-ne més →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back flip-card-back--17">
                                ...
                                <a href="../proc/odss.php?ods=17" class="flip-card__btn">Saber-ne més →</a>
                            </div>
                        </div>
                    </div>
