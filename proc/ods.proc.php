    ...
    switch ($ods){
        case 3:
            return [
                ...
                "img" =>'<img src="../img/ods/ods3.jpg" alt="ODS 3" class="ods-detail-hero__img">',
                ...
                "nav" => '<a href="../pages/ods.php" class="ods-nav__back">← Tornar als ODS</a>
                        <div class="ods-nav__arrows">
                            <a href="../pages/odss.php?ods=10" class="ods-nav__next">ODS 10 →</a>
                        </div>'
            ];
        case 10:
            return [
                ...
                "subtitol" =>"<p>Reduir la desigualtat dins dels països i entre ells, garantint l'accés igualitari a recursos
                            i oportunitats.</p>",
                "img" =>'<img src="../img/ods/ods10.jpg" alt="ODS 10" class="ods-detail-hero__img">',
                ...
                "nav" => '<a href="../pages/ods.php" class="ods-nav__back">← Tornar als ODS</a>
                            <div class="ods-nav__arrows">
                                <a href="../pages/odss.php?ods=3" class="ods-nav__prev">← ODS 3</a>
                                <a href="../pages/odss.php?ods=12" class="ods-nav__next">ODS 12 →</a>
                            </div>'
            ];
        case 12: 
            return [
                ...
                "img" =>'<img src="../img/ods/ods12.jpg" alt="ODS 12" class="ods-detail-hero__img">',
                ...
                "nav" => '<a href="../pages/ods.php" class="ods-nav__back">← Tornar als ODS</a>
                        <div class="ods-nav__arrows">
                            <a href="../pages/odss.php?ods=10" class="ods-nav__prev">← ODS 10</a>
                                <a href="../pages/odss.php?ods=17" class="ods-nav__next">ODS 17 →</a>
                        </div>'
            ];
        case 17:
            return [
                ...
                "subtitol" =>"<p>Enfortir els mitjans d'implementació i revitalitzar l'Aliança Mundial per al Desenvolupament
                            Sostenible.</p>",
                "img" =>'<img src="../img/ods/ods17.jpg" alt="ODS 17" class="ods-detail-hero__img">',
                ...
                "nav" => '<a href="../pages/ods.php" class="ods-nav__back">← Tornar als ODS</a>
                        <div class="ods-nav__arrows">
                            <a href="../pages/odss.php?ods=12" class="ods-nav__prev">← ODS 12</a>
                        </div>'
            ];
    }
